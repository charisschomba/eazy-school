...
import com.chariss.eazyschool.repository.CoursesRepository;
import com.chariss.eazyschool.repository.EazyClassRepository;
...
public class AdminController {
    ...
    public ModelAndView displayClasses(Model model) {
        List<EazyClass> eazyClasses = (List<EazyClass>) eazyClassRepository.findAll();
    ...
    public ModelAndView addNewClass(Model model, EazyClass eazyClass) {
    ...
    public ModelAndView addStudent(Model model, Person person, HttpSession session) {
...
//       List<Courses> courses = (List<Courses>) coursesRepository.findByOrderByCourseIdDesc();
        List<Courses> courses = (List<Courses>) coursesRepository.findAll(Sort.by("courseId").descending());
    ...
    public ModelAndView addStudentToCourse(Model model, @ModelAttribute("person") Person person, HttpSession session, @RequestParam(required = false) String error) {
        String errorMessage;
        ModelAndView modelAndView = new ModelAndView();
